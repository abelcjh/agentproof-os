...
class IntakeAgent:
    ...
    def run(self, state: RunState) -> None:
        ...
        state.normalized_case = normalized | {"missing_fields": missing}
...
class EvidenceAgent:
    ...
    def run(self, state: RunState) -> None:
        ...
        output = {"evidence_count": len(evidence), "evidence": evidence}
...
class PolicyAgent:
    ...
    def run(self, state: RunState) -> None:
        ...
        state.proposal = {"reconciliation": reconciliation, "policy": policy}
